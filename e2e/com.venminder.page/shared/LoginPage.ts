...
export class LoginPage extends BasePage {
  ...
  generalUserLogoff() {
    browser.wait(until.elementToBeClickable(LoginPageOR.loggedIn_user_btn), 100000, "user circle is not clickable");
    LoginPageOR.loggedIn_user_btn.click();
    browser.wait(until.elementToBeClickable(LoginPageOR.generalUserlogoutBtn), 50000, "logout button is not clickable");
