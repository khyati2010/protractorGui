...
export class LoginPageOR {
  ...
  static login_button = element(by.name("button"));
  static error_message = element(by.css("div.validation-summary-errors>ul>li"));
  static loggedIn_user_btn = element(
    by.xpath("//*[@class='btn btn-primary btn-circle']")
  );
  static logoutBtn = element(
    by.xpath(
      "//a[contains(@href,'https://sand-dev-2-rsd.venminder.com/Account/Logout')]"
    )
  );
  static generalUserlogoutBtn = element(
