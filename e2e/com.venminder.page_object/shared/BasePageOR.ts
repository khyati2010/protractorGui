...
export class BasePageOR {
  ...
  static loadingCircleIndicator = element(by.xpath("//img[@ref='imgElem']"));
  // Profile Menu items
  static profileIcon_new = element(
    by.xpath("//button[@class='btn btn-primary btn-circle']/i")
  );
  static profileIcon_old = element(
    by.xpath("//img[@class='header-icon pointer']")
  );
  static adminPanelLink_new = element(
  ...
  static inputVendorSearch_new = element(
    by.xpath("//form[@class='form-inline']//input")
  );
  static inputVendorSearch_old = element(
    by.xpath("//form[@id='vendorProductSearchHeader']//input")
  );
  static vendorNameSearchList_new = element.all(
    by.xpath("//div[@class='list-group']//div[@class='strong noWrap']")
  );
  static vendorProductNameSearchList_new = element.all(
    by.xpath("//div[@class='list-group']//div[@class='noWrap']")
  );

  static vendorNameSearchList_old = element.all(
    by.xpath("//li[@class='ui-menu-item']//span[1]")
  );
  static vendorProductNameSearchList_old = element.all(
    by.xpath("//li[@class='ui-menu-item']//span[2]")
  );
}
